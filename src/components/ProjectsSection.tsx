...
const techIcons: Record<string, { svg: string; color: string }> = {
  ...
  Matplotlib: { svg: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 3a7 7 0 1 1 0 14 7 7 0 0 1 0-14z", color: "#11557C" },
  Seaborn: { svg: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 3a7 7 0 1 1 0 14 7 7 0 0 1 0-14z", color: "#444876" },
  Expo: { svg: "M12 1.5C6.21 1.5 1.5 6.21 1.5 12S6.21 22.5 12 22.5 22.5 17.79 22.5 12 17.79 1.5 12 1.5zm0 3.75a6.75 6.75 0 1 1 0 13.5 6.75 6.75 0 0 1 0-13.5z", color: "#000020" },
...
function TechIcon({ name }: { name: string }) {
  ...
  return (
    <div className="group/icon relative flex items-center justify-center w-9 h-9 rounded-lg bg-slate-700/50 border border-purple-500/20 hover:border-blue-500/40 hover:scale-110 hover:-translate-y-0.5 transition-all duration-300 cursor-default">
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill={tech.color}>
        <path d={tech.svg} />
      </svg>
